@extends('layouts.app', ['activePage' => 'upload-moral', 'titlePage' => __('Moral Auditor Fies Upload')])
...
<div class='navbar-form'>
        <form action="{{action('AuditorController@submitMoralform')}}" method="POST"  enctype="multipart/form-data">
{{csrf_field()}}

            <div class="card">
                <div class=" card-header card-header-primary">
                    <h4 class="card-title "> Legal Person Informations </h4>
                  ...
                  <p> </p>
                    ...
                    <div class="col-sm-12">
                      <input type="text" class="form-control pl-5"  name="id" id="id" hidden>
                        ...
                        <!-- type div -->
                          <div class="col-sm-12">
                      <input type="text" class="form-control pl-5"  name="type" id="type"  value='moral' hidden>
                    </div
   ...
   <!--Physical Person Files Upload Section -->
                     ...
                     <p>  </p>
                         ...
                         <div class=" card-header card-header-primary">
                    <h4 class="card-title "> Legal Person Upload Files Section </h4>
                     </div>
                      <p>  </p>
                     <p>  </p>
                 ...
                 <p class="card-header"> PS : All Files Must be Any Image Format !! And all Are Required </p>
                    <ul>
                     ...
                     <input type="file" class=""  id="File1" name="Moralfilesnames[]"
                     ...
                     <input type="file" class=""  id="File2" name="Moralfilesnames[]"
                     ...
                     <input type="file" class=""  id="File3" name="Moralfilesnames[]"
                           accept=".jpg, .jpeg, .png" required>
                         </div>
 			   ...
 			   <!-- File 4 Upload -->
                     ...
                     <input type="file" class=""  id="File4" name="Moralfilesnames[]"
                           accept=".jpg, .jpeg, .png" required>
                         </div>
                     ...
                     <input type="file" class=""  id="File5" name="Moralfilesnames[]"
                           accept=".jpg, .jpeg, .png" required>
                         </div>
                     ...
                     <input type="file" class=""  id="File6" name="Moralfilesnames[]"
                           accept=".jpg, .jpeg, .png" required>
                         </div>
                     ...
                     <input type="file" class=""  id="File7" name="Moralfilesnames[]"
                           accept=".jpg, .jpeg, .png" required>
                         </div>
                     ...
                     <input type="file" class=""  id="File8" name="Moralfilesnames[]"
                           accept=".jpg, .jpeg, .png" required>
                         </div>
                     ...
                     <input type="file" class=""  id="File9" name="Moralfilesnames[]"
                           accept=".jpg, .jpeg, .png" required>
                         </div>
                     ...
                     <input type="file" class=""  id="File10" name="Moralfilesnames[]"
                           accept=".jpg, .jpeg, .png" required multiple>
                         </div>
                     ...
                     <input type="file" class=""  id="File11" name="Moralfilesnames[]"
                           accept=".jpg, .jpeg, .png" required>
                         </div>
                     ...
                     <input type="file" class=""  id="File12" name="Moralfilesnames[]"
                           accept=".jpg, .jpeg, .png" required>
                         </div>
                     <p> </p>
                     <p> </p>
